...
export type JsonValue = Primitive | readonly JsonValue[] | JsonObject;
export type DeepReadonly<T> = T extends Primitive ? T : T extends (...args: any[]) => any ? T : T extends readonly (infer U)[] ? readonly DeepReadonly<U>[] : {
